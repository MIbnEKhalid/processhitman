...
void CreateUIElements(HWND hwnd)
{
    ...
    hwndSmallText = CreateWindowEx(0, "STATIC", "Press Window + Alt + f5 To kill Application.", WS_CHILD | WS_VISIBLE | SS_CENTER,
                                   50, 70, 300, 20, hwnd, NULL, NULL, NULL);
    ...
    // Button
    hwndButton = CreateWindowEx(0, "BUTTON", "Enable Process Hitman", WS_TABSTOP | WS_VISIBLE | WS_CHILD | BS_DEFPUSHBUTTON,
                                (400 - 180) / 2, 180, 180, 30, hwnd, (HMENU)ID_BUTTON, (HINSTANCE)GetWindowLongPtr(hwnd, GWLP_HINSTANCE), NULL);
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    // Create the window
    hwnd = CreateWindowEx(0, CLASS_NAME, "Process Hitman | Window + Alt + F5 to kill processes", WS_OVERLAPPEDWINDOW,
